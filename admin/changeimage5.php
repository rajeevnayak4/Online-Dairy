...
move_uploaded_file($_FILES["img5"]["tmp_name"],"img/product/".$_FILES["img5"]["name"]);
...
<head>
	...
	<title>OnlineDairy | Admin Update Image 5</title>
											...
											<div class="form-group">
												...
												if ($query->rowCount() > 0) {
													foreach ($results as $result) {	?>
														...
														<div class="col-sm-8">
															<img src="img/product/<?php echo htmlentities($result->Vimage5); ?>" width="300" height="200" style="border:solid 1px #000">
														</div>
												<?php }
												} ?>
											</div>
